...
//    }
    ...
    public void run () throws InterruptedException,IOException, NoSuchAlgorithmException {
        ...
        while (hasLoggedIn) {
            ...
            switch (menuValue) {
                case 1 -> {
                    new ClientRequestBroadcast(this).request();
                }
                case 2 -> {
                    new ClientRequestListRequest(this).request();
                }
                case 3 -> {
                    new ClientRequestPrivateMessage(this).request();
                }
                case 4 -> {
                    new ClientRequestSurvey(this).request();
                }
                case 5 -> {
                   new ClientRequestSurveyEvent(this).request();
                }
                case 6 -> {
                    new ClientRequestFileTransfer(this).request();
                }
                case 7 -> {
                    new ClientRequestEncryptedMessage(this).request();
                }
                case 8 -> {
                    new ClientRequestQuit(this).request();
                }
//                    case 9, 0 -> {
//                        if (!transferRequest) {
